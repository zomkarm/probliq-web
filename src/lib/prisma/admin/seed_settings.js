...
export async function SettingSeeder() {
  try {
    ...
    await prisma.setting.createMany({
      data: [
        { key: 'APP_NAME', value: 'Probliq', description: 'Application name' },
        ...
        { key: 'INVOICE_FOOTER_TEXT', value: 'Thanks for using Probliq!', description: 'Invoice footer' },
        ...
        { key: 'EMAIL_FROM_NAME', value: 'Probliq', description: 'Sender name' },
