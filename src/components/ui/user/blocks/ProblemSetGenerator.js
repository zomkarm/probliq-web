...
export default function ProblemSetGenerator() {
  const [step, setStep] = useState(0);
  const [isInitialized, setIsInitialized] = useState(false);
  const { setProblemSetMeta } = useProblemStore();

  if (!isInitialized) {
    return <ProblemSetInit onSubmit={(data) => {
      setProblemSetMeta(data);
...
function ProblemSetInit({ onSubmit }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#020617] text-white px-6">
      ...
      <div className="relative w-full max-w-md">
        {/* glow border */}
        <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500/20 to-blue-500/20 rounded-3xl blur-xl" />

        <div className="relative p-8 rounded-3xl border border-slate-800 bg-[#020617]/80 backdrop-blur-xl shadow-2xl space-y-6">
          
          {/* header */}
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-black tracking-tight bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent">
              Create Problem Set
            </h1>
            <p className="text-sm text-slate-500">
              Give your session a name before starting
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="e.g. Career Stress Breakdown"
              className="w-full px-4 py-3 rounded-xl bg-slate-900/60 border border-slate-700 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-sm transition-all"
            />
          </div>
          ...
          <button
            onClick={handleStart}
            className="w-full py-3 rounded-xl bg-white text-[#020617] font-black hover:bg-indigo-50 transition-all shadow-lg active:scale-95 disabled:opacity-40"
            disabled={!name.trim()}
          >
            Start Session
          </button>
...
function CompletionUI() {
  ...
  const { problems, problemSetMeta } = useProblemStore();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#020617] px-6 text-white">
      {/* background glow */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-indigo-500/10 blur-[120px] rounded-full" />
        <div className="absolute top-[20%] -right-[10%] w-[30%] h-[30%] bg-blue-600/10 blur-[100px] rounded-full" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative p-8 rounded-3xl border border-slate-800 bg-[#020617]/80 backdrop-blur-xl shadow-2xl space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500">
              Your problem set is ready to be saved
            </p>
          </div>
          ...
          <button
            onClick={handleSave}
            disabled={loading}
            className="w-full py-3 rounded-xl bg-white text-[#020617] font-black hover:bg-indigo-50 transition-all shadow-lg active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed"
          >
